...
must_haves:
  truths:
    ...
    - "Changes persist after page refresh and session restart"
  artifacts:
...
21. Close browser tab, reopen http://localhost:3000
22. Verify: All custom groupings still preserved (survives session restart)

**Reset verification:**
23. Go back to Settings > Muscle Groups
24. Click "Reset to Defaults"
25. Confirm the dialog
26. Verify: Groups reset to Push, Pull, Legs, Core
  </how-to-verify>
...
- Changes persist across page refresh AND session restart
